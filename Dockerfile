# Bill Watch -- imagem do agente, derivada da base cloud da Plow.
#
...
COPY LICENSE NOTICE /usr/share/doc/bill-watch/
...
COPY bw-setup/            /opt/hermes/skills/bw-setup/
COPY bw-report/           /opt/hermes/skills/bw-report/
COPY bw-explain/          /opt/hermes/skills/bw-explain/
COPY bw-cancel/           /opt/hermes/skills/bw-cancel/
COPY bw-shared/           /opt/hermes/skills/bw-shared/
...
COPY bw-shared/ /opt/plow/bw-shared/
